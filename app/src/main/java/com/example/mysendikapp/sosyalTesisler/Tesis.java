...
public class Tesis extends AppCompatActivity {
    String TAG = "Tesis";
    ...
    ArrayList<String> TesisSecenekleri;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tesis);

        btnTarihSec = (Button) findViewById(R.id.btn_tarihsec_tesis);
        ...
        btnSend = (Button) findViewById(R.id.btn_send_tesis);
        ...
        ///
        TesisSecenekleri = new ArrayList<String>();
        sp = (Spinner) findViewById(R.id.sp_tesisSec);

        etKisiSayisi = (EditText) findViewById(R.id.et_kisiSayisi_tesis);
    }
    ...
    public void pickDate(final int whichDate) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(Tesis.this,
